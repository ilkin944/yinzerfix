...
<![endif]-->
  ...
  <title>Password Reset for your YinzerFIX account</title>
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    <img align="center" border="0" src="https://img.freepik.com/free-vector/bird-colorful-logo-gradient-vector_343694-1365.jpg" alt="Image" title="Image"
                          ...
                          <tr>
                            <td
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                    <img align="center" border="0" src="https://cdn3d.iconscout.com/3d/premium/thumb/reset-password-3d-icon-download-in-png-blend-fbx-gltf-file-formats--forgot-lock-security-system-protection-pack-crime-icons-8341655.png?f=webp" alt="Image" title="Image"
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href=" " title="Facebook" target="_blank">
                                            <img src="https://upload.wikimedia.org/wikipedia/commons/b/b9/2023_Facebook_icon.svg" alt="Facebook" title="Facebook" width="32"
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href=" " title="Twitter" target="_blank">
                                            <img src="https://logos-world.net/wp-content/uploads/2023/08/X-Logo.png" alt="Twitter" title="Twitter" width="32"
                                              style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                          </a>
                                        </td>
                                      </tr>
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href=" " title="Instagram" target="_blank">
                                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Instagram_logo_2016.svg/2048px-Instagram_logo_2016.svg.png" alt="Instagram" title="Instagram" width="32"
                                              style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                          </a>
                                        </td>
                                      </tr>
                                      ...
                                      <tr style="vertical-align: top">
                                        <td align="left" valign="middle"
                                          ...
                                          <a href=" " title="LinkedIn" target="_blank">
                                            <img src="https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png" alt="LinkedIn" title="LinkedIn" width="32"
                                              style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                          </a>
                                        </td>
                                      </tr>
...
export const newCustomerRequest = (user: {fullName:string, phone:string, email:string, subject:string, address:string, zipCode:string, date:string, time:string}): string => {
  return `
    ...
    <tr>
      ...
      >
        <img
          align="center"
          border="0"
          src="https://pixcap.com/cdn/library/template/1717723494111/thumbnail/Advertisement_3D_Icon_Model_For_UI_transparent_800_emp.webp"
          alt="Image"
          title="Image"
          style="
            outline: none;
    ...
    <p style="font-size: 14px; line-height: 140%">
      <span
        style="
          ...
          color: #666666;
        "
        >This request sent by ${user.fullName}</span
      >
    </p>
    <p style="font-size: 14px; line-height: 140%">
      &nbsp;
    ...
    <p style="font-size: 14px; line-height: 140%">
      <span
        style="
          ...
          color: #666666;
        "
        >User requested service: ${user.subject}
      </span>
    </p>
    <p style="font-size: 14px; line-height: 140%">
      <span
    ...
    <p style="font-size: 14px; line-height: 140%">
      <span
        style="
          ...
          color: #666666;
        "
        >User e-mail address: <a target="_blank" href="mailto:${user.email}">${user.email}</a>
      </span>
    </p>
    <p style="font-size: 14px; line-height: 140%">
      <span
    ...
    <p style="font-size: 14px; line-height: 140%">
      <span
        style="
          ...
          color: #666666;
        "
        >User available at this date: ${user.date}
      </span>
    </p>
    <p style="font-size: 14px; line-height: 140%">
      <span
        style="
          ...
          color: #666666;
        "
        >User available at this time: ${user.time}
      </span>
    </p>
  </div>
</td>
